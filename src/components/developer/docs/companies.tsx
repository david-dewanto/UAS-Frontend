...
const CompaniesDocumentation = () => {
  ...
  // Your existing example variables
  const symbolsResponseExample = `{
    "symbols": [ "AALI", "ABBA", "ABDA", "ZBRA" ],
    "count": 825
}`;
  ...
  if (loading) {
    return (
      <div className="space-y-8">
        ...
        {/* Symbols Endpoint Documentation Skeleton */}
        <Card>
          <CardHeader>
            <Skeleton className="h-8 w-72 mb-2" />
            <Skeleton className="h-4 w-96" />
        ...
        {/* Company Details Endpoint Documentation Skeleton */}
        <Card>
          <CardHeader>
            <Skeleton className="h-8 w-72 mb-2" />
            <Skeleton className="h-4 w-96" />
