...
import { ChevronDown, BarChart, LogOut, Plus, Key, BookOpen, Route, Zap, ChartCandlestick, ChartPie } from "lucide-react"
...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { 
        ...
        path: "/dashboard/investments/portfolio-analysis",
